...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Online'
        db.create_table(u'onlineuser_online', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='online', unique=True, null=True, to=orm['core.User'])),
        ...
        db.send_create_signal(u'onlineuser', ['Online'])


    def backwards(self, orm):
        # Deleting model 'Online'
        db.delete_table(u'onlineuser_online')
    ...
    models = {
        ...
        u'onlineuser.online': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'online'", 'unique': 'True', 'null': 'True', 'to': u"orm['core.User']"})
        }
    }

    complete_apps = ['onlineuser']